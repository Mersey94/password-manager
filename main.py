"""Password Manager Main file 1/2"""
from tkinter import *
...
# ---------------------------- UI COLORS AND FONT ------------------------------- #
WINDOW_ICONBITMAP = "melogo.ico"
WINDOW_BG = "#F0F0F0"
FIELD_COLORS = "#dddddd"
FIELD_FONT_COLOR = "#585DB6"
LABEL_COLOR = "black"
FONT = ("Terminal", 15, "normal")
# ---------------------------- PASSWORD GENERATOR ------------------------------- #
...
# set default email
email_entry.insert(0, "merseyhouston@hotmail.com")
